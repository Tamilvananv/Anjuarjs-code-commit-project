...
import { BlockContainer, BlockWidget, BodyWidget, CommentElementBox, HeaderFooterWidget, LineWidget, Page, ParagraphWidget, Rect, TableCellWidget, TableRowWidget, TableWidget, TextElementBox, Widget, FootnoteElementBox, FootNoteWidget } from './page';
...
export declare class Layout {
     ...
     * @private
     */
    startAt(element: FootnoteElementBox, text: string): string;
    ...
    shiftFootnoteChildLocation(widget: FootNoteWidget, viewer: LayoutViewer): void;
    /**
