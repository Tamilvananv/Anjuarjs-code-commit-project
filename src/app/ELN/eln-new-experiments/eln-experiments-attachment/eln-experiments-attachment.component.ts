...
@Component({
  selector: 'app-eln-experiments-attachment',
  templateUrl: './eln-experiments-attachment.component.html',
  styleUrls: ['./eln-experiments-attachment.component.css'],
  providers: [NavigationPaneService, ToolbarService, DetailsViewService]
})
export class ElnExperimentsAttachmentComponent implements OnInit, AfterViewInit {
  ...
  beforeSend(args) {
    ...
    let restrictedPath = "eln/e_" + (this.expVersionObj.ExperimentId > 0 ? this.expVersionObj.ExperimentId.toString() : "") +
