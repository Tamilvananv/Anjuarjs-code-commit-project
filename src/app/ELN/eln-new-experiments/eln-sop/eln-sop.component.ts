...
import { ExpVersionEnt, SOPEnt } from "../service/experiment.model";
...
@Component({
  selector: 'app-eln-sop',
  templateUrl: './eln-sop.component.html',
  providers: [EditService, SortService],
  styleUrls: ['./eln-sop.component.css']
})
export class ElnSopComponent implements OnInit {
