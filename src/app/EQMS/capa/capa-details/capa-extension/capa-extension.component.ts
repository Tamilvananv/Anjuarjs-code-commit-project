...
@Component({
  selector: 'app-capa-extension',
  templateUrl: './capa-extension.component.html',
  providers:[ToolbarService],
  styleUrls: ['./capa-extension.component.css']
})
export class CapaExtensionComponent implements OnInit {
