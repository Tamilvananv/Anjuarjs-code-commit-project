...
import { ExpVersionEnt } from './qcelnexperiment.model';

@Injectable({
    providedIn: 'root'
})
export class QCExperimentService {
    ...
    getTestMaterialId(expVersionObj:ExpVersionEnt) {
        let params = new HttpParams();
        params = params.append('VersionId',expVersionObj.VersionId>0? expVersionObj.VersionId.toString():"0");
        return this._http.get(this._restApi + 'GetTestMaterialId', { params: params });
    }
    getSampleBarcode(expVersionObj:ExpVersionEnt) {
        let params = new HttpParams();
        params = params.append('VersionId',expVersionObj.VersionId>0? expVersionObj.VersionId.toString():"0");
        return this._http.get(this._restApi + 'GetSampleBarcode', { params: params });
    }
    getTestTypeId(expVersionObj:ExpVersionEnt) {
        let params = new HttpParams();
        params = params.append('VersionId', expVersionObj.VersionId>0? expVersionObj.VersionId.toString():"0");
        return this._http.get(this._restApi + 'GetTestTypeId', { params: params });
    }
    getTypeId(expVersionObj:ExpVersionEnt) {
        let params = new HttpParams();
        params = params.append('VersionId', expVersionObj.VersionId>0? expVersionObj.VersionId.toString():"0");
        return this._http.get(this._restApi + 'GetTypeId', { params: params });
    }
    getUserList() {
        return this._http.get(this._restApi + 'GetUserList');
    }
