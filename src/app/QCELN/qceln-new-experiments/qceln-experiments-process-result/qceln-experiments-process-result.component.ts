...
import { ProcessEnt, ExpVersionEnt } from "../service/qcelnexperiment.model";
...
@Component({
  selector: 'app-qceln-experiments-process-result',
  templateUrl: './qceln-experiments-process-result.component.html',
  providers: [ToolbarService],
  styleUrls: ['./qceln-experiments-process-result.component.css']
})
export class QCElnProcessSummaryComponent implements OnInit {
