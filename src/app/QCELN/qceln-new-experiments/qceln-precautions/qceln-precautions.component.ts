...
import { ExpVersionEnt, ProcessEnt } from "../service/qcelnexperiment.model";
...
@Component({
  selector: 'app-qceln-precautions',
  templateUrl: './qceln-precautions.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./qceln-precautions.component.css']
})
export class QCElnPrecautionsComponent implements OnInit {
